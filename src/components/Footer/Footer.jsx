const Footer = () => {
    return (
        <div>
            <footer className=" static bottom-0 footer items-center container mx-auto text-center p-4 bg-neutral text-neutral-content">
                <aside className="items-center grid-flow-col">
                    ...
                    <p> &copy; Md. Muhaimin Islam Tanvir - All right reserved</p>
                </aside>
